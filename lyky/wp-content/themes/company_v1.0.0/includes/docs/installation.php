...
<ol>
	...
	<li>Click the Upload button to upload the <strong>company.zip</strong> file that you have previously downloaded to your machine.</li>
...
<p>
<ol>
	<li>Unzip the <strong>company.zip</strong> file that you have previously downloaded to your machine, you may see all theme files are located in the <strong>/company</strong> folder.</li>
	<li>Using an FTP client to access your host web server.</li>
	<li>Upload the <strong>/company</strong> folder to the /wp-content/themes/ directory on your host server.</li>
