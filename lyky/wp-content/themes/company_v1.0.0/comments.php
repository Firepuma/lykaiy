...
/*-----------------------------------------------------------------------------------*/
	...
	if ( have_comments() ) :
        ...
        if ( ! empty($comments_by_type['comment']) ) : // if there are normal comments ?>
	        ...
	        <h3 class="comments-title"><?php comments_number(__('0 Comment', 'junkie'), __('1 Comment', 'junkie'), __('% Comments', 'junkie')); ?></h3>
        ...
        if ( ! empty($comments_by_type['pings']) ) : // if there are pings ?>
			...
			<div class="pings-wrapper">
	    		<h3 class="pings-title"><?php _e('Trackbacks', 'junkie') ?></h3>
...
/*-----------------------------------------------------------------------------------*/
	elseif ( ! comments_open() && ! is_page() && post_type_supports( get_post_type(), 'comments' ) ) : ?>
		...
		<p class="nocomments"><?php _e('Comments are closed.', 'junkie') ?></p>
