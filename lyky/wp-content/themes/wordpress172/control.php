<?php
$themename = "Tencent CDC";    //主题名称
$shortname = "mao10";    //主题简写，必须是英文、数字、下划线组合
$options = array (
    array("name" => "首页幻灯设置","type" => "heading","desc" => "幻灯图片大小建议1280 x 399px."),
	array("name" => "幻灯图片地址01","id" => $shortname."_hdimg01","std" => "","type" => "text"),
	array("name" => "幻灯图片地址02","id" => $shortname."_hdimg02","std" => "","type" => "text"),
	array("name" => "幻灯图片地址03","id" => $shortname."_hdimg03","std" => "","type" => "text"),
	array("name" => "幻灯图片地址04","id" => $shortname."_hdimg04","std" => "","type" => "text"),
	array("name" => "幻灯图片地址05","id" => $shortname."_hdimg05","std" => "","type" => "text"),
	array("name" => "幻灯图片地址06","id" => $shortname."_hdimg06","std" => "","type" => "text"),
);
